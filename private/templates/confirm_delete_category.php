...
<div class="grid_index m-5">
    ...
    <div class="alert alert-danger grid_index m-5">
        ...
        <?php endif; ?>
        <br>
        <a class="grid_index m-5" href="../controller/DeleteCategory.php?category_id=<?= $category_id; ?>" class="alert-link">Je souhaite supprimer cette catégorie.</a>
    </div>
